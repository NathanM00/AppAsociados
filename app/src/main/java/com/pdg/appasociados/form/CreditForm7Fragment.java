...
import com.pdg.appasociados.HomeFragment;
import com.pdg.appasociados.R;

public class CreditForm7Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        vista = inflater.inflate(R.layout.fragment_credit_form7, container, false);
